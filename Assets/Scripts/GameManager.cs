...
public class GameManager : MonoBehaviour
{
    ...
    public (Vector3, Vector3, Vector3, Vector3) GetObservationsFromAlliancePerspective(GameObject robot)
    {
        ...
        // If the robot is blue, then we will return the position vectors as normal.
        // If the robot is red, then we will return the position vectors as flipped.
        // This is because the blue robot is on the left side of the field, and the red robot is on the right side of the field.


        // set a boolean to see if the robot is blue or red
        bool isBlue = robot == blueAllianceRobot15 || robot == blueAllianceRobot24;

        // if the robot is blue, return all of the positions of the robots
        if (isBlue)
        {
            return (
        ...
        } // otherwise, return all of the positions of the robots flipped across the origin
        else
        {
            return (
                new Vector3(-redAllianceRobot15.transform.position.x, -redAllianceRobot15.transform.position.y, -redAllianceRobot15.transform.position.z),
                new Vector3(-redAllianceRobot24.transform.position.x,- redAllianceRobot24.transform.position.y, -redAllianceRobot24.transform.position.z),
                new Vector3(-blueAllianceRobot15.transform.position.x, -blueAllianceRobot15.transform.position.y, -blueAllianceRobot15.transform.position.z),
                new Vector3(-blueAllianceRobot24.transform.position.x, -blueAllianceRobot24.transform.position.y, -blueAllianceRobot24.transform.position.z)
            );
        }
